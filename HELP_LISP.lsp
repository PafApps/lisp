...
(defun create_dclhelplispСИТУАЦИЯ (fn / dcl_content command_items)
  ...
  (setq command_items
    '(
      ...
      (""7777777777777777"" ""   7777777777777777  "" ""  - 5gfdffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff fffffffff ffffffffffff ffffffffff fffffff"")
    )
  )
...
(defun create_dclhelplispДРУГИ (fn / dcl_content command_items)
  ...
  (setq command_items
    '(
      ...
      ("BATCHETR" "BATCH ETR" "  - Прави eTransmit на избрани от теб файлове (не пипай преди да е завършило).")
      ("BATCHPDF" "BATCH PDF" "  - Прави PDF-и на избрани от теб файлове като пита за всеки един дали искаш подписи и къде да го запази.")
      ("BATCHPDF2" "BATCH PDF2" "  - Прави PDF-и на избрани от теб файлове като заси подписи в слаой Signature и сейва PDF във папката, в която е файла.")
