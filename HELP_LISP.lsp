    ...
    public static class CommandDatabase
    {
        ...
        public static readonly Dictionary<string, List<MenuItem>> Menus = new Dictionary<string, List<MenuItem>>
        {
            ...
            { "ДРУГИ", new List<MenuItem> {
                ...
                new MenuItem { Key = "DataSelect", Label = "DataSelect", Description = "- Сменя датата на избрани от теб файлове, без да се налага да ги отваряш", AutoCADCommand = "DataSelect" },
                new MenuItem { Key = "RemoveSignAll", Label = "RemoveSignAll", Description = "- Премахва подписите на всички файлове от избрана от теб папка, без да се налага да отваряш файловете", AutoCADCommand = "RemoveSignAll" },
